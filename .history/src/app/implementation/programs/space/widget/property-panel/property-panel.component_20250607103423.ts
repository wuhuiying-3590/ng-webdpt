...
export class PropertyPanelComponent implements OnInit, OnDestroy {
  ...
  getLineSpaceOptions: (type: string) => any[];
  internalSpaceOption = [];
  borderRadiusOption = [];
  backgroundTypeOption = [];
  chooseColorOption = [];
  ...
  initData() {
    this.getLineSpaceOptions = getLineSpaceOptions;
    this.internalSpaceOption = internalSpaceOption;
    ...
    this.slotLineSpaceOption = slotLineSpaceOption;
    this.slotInternalSpaceOption = slotInternalSpaceOption;
  }
  getLineSpaceOption(type) {}
  watchChange() {
