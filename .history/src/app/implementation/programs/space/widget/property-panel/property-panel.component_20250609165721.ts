...
export class PropertyPanelComponent implements OnInit, OnDestroy {
  ...
  getLineSpaceOption: (type: string) => any[];
  getInternalSpaceOption: (type: string) => any[];
  borderRadiusOption = [];
  backgroundTypeOption = [];
  chooseColorOption = [];
  positionXOption = [];
  ...
  constructor(
    ...
    this.propertyForm = this.fb.group({
      ...
      customWidth: [null],
      customHeight: [null],
      buttonTypeOption: [null],
      buttonWidthOption: [null],
  ...
  initData() {
    ...
    this.borderRadiusOption = borderRadiusOption;
    this.backgroundTypeOption = backgroundTypeOption;
    this.chooseColorOption = chooseColorList;
    this.positionXOption = positionXOption;
    this.positionYOption = positionYOption;
    this.fontWeightOption = fontWeightOption;
    this.fontSizeOption = fontSizeOption;
    this.textAlignOption = textAlignOption;
    this.marginOption = marginOption;
    this.borderTypeOption = borderTypeOption;
    this.modeOption = modeOption;
    this.fixedSizeOption = fixedSizeOption;
    this.buttonTypeOption = buttonTypeOption;
    this.buttonWidthOption = buttonWidthOption;
