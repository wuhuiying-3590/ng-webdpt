...
export class ListItemComponent implements OnInit {
  ...
  componentSortablejsOptions = {
    ...
    onAdd: (evt) => {
      ...
      console.log('onAdd---componentSortablejsOptions', cIndex);
    },
    onEnd: (evt) => {
      console.log('onEnd---componentSortablejsOptions', evt);
      this.cdr.detectChanges();
    },
  };
  ...
  slotSortablejsOptions = {
    ...
    onAdd: (evt) => {
      ...
      const componentId = item.getAttribute('data-c-Id');
      const component = item.getAttribute('data-c');
      console.log(
        'onAdd---slotSortablejsOptions',
        evt,
        componentType,
        typeof component
      );
      ...
      evt.to.removeChild(item);
      this.canvasDataService.removeComponent({ id: componentId });
      ...
      if (componentType) {
        ...
        this.canvasDataService.addComponentWithData(component, pId, cIndex);
      }
    },
    onEnd: (evt) => {
      console.log('onEnd---slotSortablejsOptions');
    },
  };
}
