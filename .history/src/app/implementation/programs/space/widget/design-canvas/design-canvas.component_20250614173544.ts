...
export class DesignCanvasComponent implements OnInit, AfterViewInit {
  ...
  showRemove = false;
  evaluateShowRemove() {
    this.showRemove = yourCondition;
  }
  showCopy() {
    //
    const parentNode = this.editPopService.selectEl.parentNode;
    console.log(
      this.editPopService.selectEl,
      parentNode,
  ...
  showRemove() {
    ...
    //   const childNodesLength = parentNode.childNodes.length;
    //   return childNodesLength > 1;
    // }
    return false;
  }
  cloneComponent(): void {
