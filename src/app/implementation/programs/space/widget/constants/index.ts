...
export const marginOption = [
  { label: '无', value: 'none' },
  { label: '小', value: 'small' },
  { label: '中', value: 'middle' },
  { label: '大', value: 'large' },
];
export const borderTypeOption = [
  { label: '直线', value: 'solid', icon: 'icon-yuanxing' },
  { label: '虚线1', value: 'dashed', icon: 'icon-xuxian' },
  { label: '虚线2', value: 'dotted', icon: 'icon--xiaoxuxian' },
];
export const modeOption = [
  { label: '固定宽度', value: 'fixed' },
  { label: '宽度铺满', value: 'fill' },
];
export const fixedSizeOption = [
  { label: '大', value: 'large' },
  { label: '中', value: 'medium' },
  { label: '小', value: 'small' },
  { label: '自定义', value: 'customize' },
];
export const buttonTypeOption = [
  {
    label: '主要按钮',
    value: 'primary',
  },
...
export const buttonWidthOption = [
  {
    label: '自适应',
    value: 'hug',
  },
...
export const getComponentByType = (componentType) => {
  return componentList.find((el) => el.type === componentType);
};
