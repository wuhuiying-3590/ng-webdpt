...
import { DwCustomTableDisplayProductInfo } from './../model/dw-custom-table-display.model';


@Component({
  selector: 'app-dw-custom-table-display-detail-edit',
  templateUrl: './dw-custom-table-display-detail-edit.component.html',
  styleUrls: ['./dw-custom-table-display-detail-edit.component.css']
})
export class DwCustomTableDisplayDetailEditComponent implements OnInit {
  public detailEditForm: FormGroup;
  public detailEdit: DwCustomTableDisplayProductInfo;
  ...
  @Input()
  set orderDetail(orderDetail: DwCustomTableDisplayProductInfo) {
   ...
   * 確定
   *
   * @memberof DwCustomTableDisplayDetailEditComponent
   */
  ...
  ngOnInit(): void {
    if (this._cmd === 'add') {
      this.detailEdit = new DwCustomTableDisplayProductInfo({});
