...
import { DwCustomTableDisplayDetailEditComponent } from './dw-custom-table-display-detail-edit.component';
@Component({
  template: `
      <app-dw-custom-table-display-detail-edit
...
class TestComponent {
  @ViewChild(DwCustomTableDisplayDetailEditComponent, { static: true }) comp: DwCustomTableDisplayDetailEditComponent;
  cmd = 'edit';
  orderDetail = {
...
describe('DwCustomTableDisplayDetailEditComponent', () => {
