...
@Component({
  selector: 'app-dw-extra-fields-document-modify',
  templateUrl: './order-modify.component.html',
  styleUrls: ['./order-modify.component.css'],
  providers: [DwDocument]
})
export class ExtraFieldsDocumentOrderModifyComponent implements OnInit, IDwDocumentOnSave, OnDestroy {
  ...
  public detailDelete(key: string, data: DwDataRow): void {
    const idx = this.detail[key].rows.findIndex
    (r => {
