...
import { ExtraFieldsOrderDetailEditComponent } from './order-detail-edit.component';
@Component({
  template: `
...
class TestComponent {
  @ViewChild(ExtraFieldsOrderDetailEditComponent, { static: true }) comp: ExtraFieldsOrderDetailEditComponent;
  cmd = 'edit';
  orderDetail = {
...
describe('ExtraFieldsOrderDetailEditComponent', () => {
