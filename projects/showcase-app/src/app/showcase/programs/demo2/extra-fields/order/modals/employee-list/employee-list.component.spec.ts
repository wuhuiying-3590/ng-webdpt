...
import { ExtraFieldsEmployeeListComponent } from './employee-list.component';
@Component({
  template: `
...
class TestComponent {
  @ViewChild(ExtraFieldsEmployeeListComponent, { static: true }) comp: ExtraFieldsEmployeeListComponent;
}
...
describe('ExtraFieldsEmployeeListComponent', () => {
  ...
  const configureTestingModule = {
    ...
    providers: [
      ...
      // {
      //   provide: ExtraFieldsEmployeeRepository, useValue: {
