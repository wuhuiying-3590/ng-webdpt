...
import { ExtraFieldsCustomerListComponent } from './customer-list.component';
@Component({
  template: `
...
class TestComponent {
  @ViewChild(ExtraFieldsCustomerListComponent, { static: true }) comp: ExtraFieldsCustomerListComponent;
}
...
describe('ExtraFieldsCustomerListComponent', () => {
