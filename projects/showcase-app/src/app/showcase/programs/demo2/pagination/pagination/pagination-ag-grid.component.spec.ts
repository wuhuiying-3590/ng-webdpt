...
import { PaginationAgGridComponent } from './pagination-ag-grid.component';


describe('PaginationAgGridComponent', () => {
  let component: PaginationAgGridComponent;
  let fixture: ComponentFixture<PaginationAgGridComponent>;
  let de: DebugElement;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [PaginationAgGridComponent],
      providers: [
      ]
    })
      .compileComponents();
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PaginationAgGridComponent);
  ...
  it('需建立ag-grid表單', waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      fixture.whenStable().then(() => {
        ...
        fixture.detectChanges();
        expect(document.querySelectorAll('.ag-center-cols-container>div').length).toEqual(5);
      });
    });
  }));
  it('按下分頁, 需觸發onDataSourceChange', waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      fixture.whenStable().then(() => {
        ...
        commonGridDataReq();
        fixture.whenStable().then(() => {
          expect(spyOnDataSourceChange).toHaveBeenCalledTimes(2);
        });
      });
    });
  }));
