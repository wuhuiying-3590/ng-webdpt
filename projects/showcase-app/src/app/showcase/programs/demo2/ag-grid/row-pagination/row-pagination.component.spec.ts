...
import { RowPaginationComponent } from './row-pagination.component';

describe('RowPaginationComponent', () => {
  let component: RowPaginationComponent;
  let fixture: ComponentFixture<RowPaginationComponent>;
  let de: DebugElement;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [RowPaginationComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(RowPaginationComponent);
