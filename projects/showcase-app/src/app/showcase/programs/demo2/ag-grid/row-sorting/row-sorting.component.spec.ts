...
import { RowSortingComponent } from './row-sorting.component';

describe('RowSortingComponent', () => {
  let component: RowSortingComponent;
  let fixture: ComponentFixture<RowSortingComponent>;
  let de: DebugElement;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [RowSortingComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(RowSortingComponent);
    ...
    commonGridDataReq = () => {
      fixture.whenStable().then(() => {
        const gridDataReq = httpMocker.expectOne('https://api.myjson.com/bins/ztxog');
  ...
  it('clearPinned', waitForAsync(() => {
    fixture.detectChanges();
    fixture.whenStable().then(() => {
      commonGridDataReq();
      expect(de.query(By.css('ag-grid-angular'))).toBeTruthy();
      component.clearPinned();
      fixture.detectChanges();
      fixture.whenStable().then(() => {
        fixture.detectChanges();
      });
  ...
  it('resetPinned', waitForAsync(() => {
    fixture.detectChanges();
    fixture.whenStable().then(() => {
      commonGridDataReq();
      expect(de.query(By.css('ag-grid-angular'))).toBeTruthy();
      component.resetPinned();
      fixture.detectChanges();
      fixture.whenStable().then(() => {
        fixture.detectChanges();
      });
