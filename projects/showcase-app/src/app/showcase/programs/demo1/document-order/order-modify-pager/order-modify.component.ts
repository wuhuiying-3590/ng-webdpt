...
@Component({
  selector: 'app-dw-document-order-modify-pager',
  templateUrl: './order-modify.component.html',
  styleUrls: ['./order-modify.component.css'],
  providers: [DwDocument]
})
export class DocumentOrderModifyPagerComponent implements OnInit, IDwDocumentOnSave, OnDestroy {
  ...
  constructor(public route: ActivatedRoute,
    ...
    this.route.queryParamMap.subscribe(
      params => {
        ...
        this.pageIndex = params.get('pageIndex') ? Number(params.get('pageIndex')) : 1;
        this.pageSize = params.get('pageSize') ? Number(params.get('pageSize')) : this.pageSize;
        this.initData();
