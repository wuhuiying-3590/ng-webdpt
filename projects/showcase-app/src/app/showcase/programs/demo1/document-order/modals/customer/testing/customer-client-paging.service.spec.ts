...
import { CustomerClientPagingService } from '../customer-client-paging.service';

describe('CustomerClientPagingService', () => {
  let srv: CustomerClientPagingService;
  beforeEach(() => {
    ...
    srv = TestBed.inject(CustomerClientPagingService);
  });
