...
describe('MockDataDataSourceService', () => {
  let srv: MockDataDataSourceService;
  ...
  beforeEach(() => {
    ...
    srv = new MockDataDataSourceService(httpClient, 'showcase/demo2/input-listwin/getInputListwinEnumData');
  });
