...
describe('EnumDataSourceService', () => {
  let srv: EnumDataSourceService;
  ...
  beforeEach(() => {
    ...
    srv = new EnumDataSourceService(httpClient, 'showcase/demo2/input-listwin/getInputListwinEnumData');
  });
