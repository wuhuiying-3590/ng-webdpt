...
describe('TableMockClientPagingService', () => {
  ...
  it('open開窗後需可返回值', fakeAsync(() => {
    ...
    srv.open([]).subscribe(result => {
      expect(result).toEqual([{ orderId: 'No_000001', orderDate: '2023/05/11', customerId: 'C02' }]);
    });
    fixture.detectChanges();
    tick(1000);
    ...
    fixture.detectChanges();
    tick(1000);
    // console.log((document.querySelector('button[ng-reflect-nz-type="primary"]') as HTMLButtonElement));
