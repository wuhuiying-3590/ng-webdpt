...
describe('SpecifyMockDataSourceService', () => {
  let srv: SpecifyMockDataSourceService;
  ...
  beforeEach(() => {
    ...
    srv = new SpecifyMockDataSourceService(httpClient, 'showcase/demo2/input-listwin/getInputListwinEnumData');
  });
