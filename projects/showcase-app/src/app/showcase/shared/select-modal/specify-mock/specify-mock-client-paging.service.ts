...
import { SpecifyMockDataSourceService } from './specify-mock-data-source.service';
import { InputListwinCustomPipe } from '../../../programs/demo2/input-listwin/input-listwin-custom.pipe';


@Injectable()
export class SpecifyMockClientPagingService {
  ...
  constructor(
    ...
    this.config = {
      ...
      dataSource: new SpecifyMockDataSourceService(this.http, 'showcase/demo2/input-listwin/getInputListwinData'),
      returnFields: ['orderId', 'orderDate', 'status', 'customerId']
    };
